...
public class DateUtil
{
	...
	public static final String FECHA_PATTERN_DD_MM_YYYY_HH_MM_A = "dd-MM-yyyy hh:mm a";
	...
	{
		return toString(ldt, DateUtil.FECHA_PATTERN_DD_MM_YYYY_HH_MM_SS_A);
	}
	...
	{
		return toString(ld, DateUtil.FECHA_PATTERN_DD_MM_YYYY);
	}
