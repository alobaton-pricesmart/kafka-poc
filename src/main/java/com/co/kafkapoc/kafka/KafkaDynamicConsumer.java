...
public class KafkaDynamicConsumer
{
	...
	{
		final ConcurrentMessageListenerContainer<String, MessageDto> container = createContainer(topic);
	...
	ConcurrentMessageListenerContainer<String, MessageDto> createContainer(String topic)
	{
